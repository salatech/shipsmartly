							...
							{trackingData.current_location_1 && (
								<TimelineEvent className={trackingData.active_1 ? "" : "faded"}>
									...
									<TimelineContent>
										...
										<TimelineMessage>{trackingData.message_1}</TimelineMessage>
									</TimelineContent>
								</TimelineEvent>
							)}
							...
							{trackingData.current_location_2 && (
								<TimelineEvent className={trackingData.active_2 ? "" : "faded"}>
									...
									<TimelineContent>
										...
										<TimelineMessage>{trackingData.message_2}</TimelineMessage>
									</TimelineContent>
								</TimelineEvent>
							)}
							...
							{trackingData.current_location_3 && (
								<TimelineEvent className={trackingData.active_3 ? "" : "faded"}>
									...
									<TimelineContent>
										...
										<TimelineMessage>{trackingData.message_3}</TimelineMessage>
									</TimelineContent>
								</TimelineEvent>
							)}
							...
							{trackingData.current_location_4 && (
								<TimelineEvent className={trackingData.active_4 ? "" : "faded"}>
									...
									<TimelineContent>
										...
										<TimelineMessage>{trackingData.message_4}</TimelineMessage>
									</TimelineContent>
								</TimelineEvent>
							)}
